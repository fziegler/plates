...
var require = {
	app: {
		analytics: true,
		copyright: "2012 by fionnziegler",
		deployType: "development",
		description: "not specified",
		guid: "866ffb10-8faa-4987-a78e-b68d0a1086fb",
		id: "com.lmc.test",
		name: "LCMTEst1",
		names: {},
		publisher: "fionnziegler",
		url: "http://",
		version: "1.0"
	},
	has: {
...
p.setString("acs-api-key-production","6xGfU465Pd8hmpMyflyMiLKNScqwX8JL");
p.setString("acs-api-key-development","4nfgEoFsZeiGSMkIZmMrs74c1cqfo0bZ");
p.setString("acs-oauth-secret-development","mW7VkrRrlh9defKdHtHzZ69RXyl4P1UJ");
p.setString("ti.map.apikey","");
p.setString("ti.ui.defaultunit","system");
p.setString("acs-oauth-secret-production","nZ5R5MAThkF028xwJmVVQjKuO7NF5d29");
p.setString("acs-oauth-key-development","WrxfHC7iu3rfdR7fCB1RZZPXfuWfyldW");
p.setString("ti.map.backend","Ti/_/Map/Google");
p.setString("ti.fs.backend","Ti/_/Filesystem/Local");
p.setString("acs-oauth-key-production","fdkMfQ3eMBUftUEO47xLNuENljI4PaoD");
});
