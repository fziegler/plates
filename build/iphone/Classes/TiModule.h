...
/**
 The base class for all LCMTEst1 modules
 */
...
/**
 LCMTEst1 Platform calls this method on startup.
 */
-(void)startup;

/**
 LCMTEst1 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 LCMTEst1 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 LCMTEst1 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 LCMTEst1 Platform calls this method on resume.
 @param sender The sender of the event.
 */
