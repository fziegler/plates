...
// in simulator we redefine to format for LCMTEst1 Developer console
...
{\
	NSString * exceptionName = [@"org.lcmtest1." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.lcmtest1";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UILCMTEst1NativeItemNone = -1, 
	UILCMTEst1NativeItemSpinner = -2,
	UILCMTEst1NativeItemProgressBar = -3,
	
	UILCMTEst1NativeItemSlider = -4,
	UILCMTEst1NativeItemSwitch = -5,
	UILCMTEst1NativeItemMultiButton = -6,
	UILCMTEst1NativeItemSegmented = -7,
	
	UILCMTEst1NativeItemTextView = -8,
	UILCMTEst1NativeItemTextField = -9,
	UILCMTEst1NativeItemSearchBar = -10,
	
	UILCMTEst1NativeItemPicker = -11,
	UILCMTEst1NativeItemDatePicker = -12,
	
	UILCMTEst1NativeItemInfoLight = -13,
	UILCMTEst1NativeItemInfoDark = -14,
	
	UILCMTEst1NativeItemDisclosure = -15,
	
	UILCMTEst1NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all LCMTEst1 instances of
