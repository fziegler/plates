 ...
 * Copyright (c) 2009-2011 by LCMTEst1, Inc. All Rights Reserved.
...
//@interface LCMTEst1Object : NSObject
//@end

@interface LCMTEst1Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[LCMTEst1Object class]])
		{
			for (NSString *key in [[(LCMTEst1Object*)o modules] allKeys])
			{
