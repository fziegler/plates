...
static NSString * const kLCMTEst1Javascript = @"Ti.App={};Ti.API={};Ti.App._listeners={};Ti.App._listener_id=1;Ti.App.id=Ti.appId;Ti.App._xhr=XMLHttpRequest;"
...
-(NSString*)_lcmtest1Injection
{
	...
	[html appendString:kLCMTEst1Javascript];
...
{
	// attempt to make well-formed HTML and inject in our LCMTEst1 bridge code
	...
	if (range.location!=NSNotFound)
	{
		...
		if (nextRange.location!=NSNotFound)
		{
			...
			[html appendString:[self _lcmtest1Injection]];
